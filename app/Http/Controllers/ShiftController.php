...
class ShiftController extends Controller
{
   ...
   public function getShift(Request $request){
        ...
        return response()->json([
            ...
            return response()->json([
                'status' => 404,
                'error' => "Tidak bisa mengambil data". $e->getMessage()
            ]);
        }
    }
...
public function getWeek(Request $request)
{
    ...
    $queryUser = "
                    ...
                    ";
    $users = DB::select($queryUser,[$divisi, $karyawan_Auth]);
...
public function isLembur(Request $request){
    ...
    // dd($data);
        ...
        return response()->json([
            'status' => 500,
            'Message' => 'Terjadi Kesalahan , Silahkan Coba beberapa saat lagi!'. $e->getMessage()
        ]);
...
public function submit(Request $request){
    ...
    try{
        ...
        return response()->json([
            'status' => 500,
            'Message' => 'Terjadi Kesalahan Menyimpan, Silahkan Coba beberapa saat lagi!'. $e->getMessage()
        ]);
