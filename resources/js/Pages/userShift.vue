...
export default {
    ...
    methods: {
        ...
        async getShift(date) {
            this.loading = true;
            try {
                const response = await axios.get("/shift/getShift", {
                    params: {
                        tanggal: date,
        ...
        async saveShift() {
            ...
            if (this.selectedEmployee && this.selectedDayIndex !== null) {
                try {
                    const response = await axios.post("/userShift/update", {
                        params: {
        ...
        async isLembur(type) {
            ...
            try {
                if (type === "assign") {
                    response = await axios.get("/shift/isLembur", {
                        params: {
        ...
        async getExportData(Start, End) {
            try {
                const response = await axios.get("/shift/getExport", {
                    params: {
                        start: Start,
                        end: End,
                    },
        ...
        async fetchWeekDates() {
            this.loading = true;
            try {
                const response = await axios.get("/getWeek", {
        ...
        async saveAssignShift() {
            ...
            try {
                const response = await axios.post("/userShift/submit", {
