                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="employee-details">
                                            <div
                                                class="flex-column-reverse employee-name m-0 p-0 d-flex align-items-start justify-content-center justify-content-md-start"
                                            >
                                                {{
                                                    employee.name
                                                        .split(" ")
...
export default {
    ...
    methods: {
        ...
        async getExportData(Start, End) {
            try {
                this.loading = true;
                const response = await axios.get("/getExport", {
                    params: {
                        start: Start,
                        end: End,
                    },
        ...
        async destroyItem(item) {
            try {
                this.loading = true;
                const response = await axios.post("/destroyOvertime", {
                    params: {
                        No_Transaksi: item,
                    },
                });
        ...
        async destroyUser(item) {
            try {
                this.loading = true;
                const response = await axios.post("/destroyUserOvertime", {
                    params: {
                        urut_Oto: item,
                    },
                });
        ...
        async getWaktuShift() {
            this.loading = true;
            try {
                const response = await axios.get("/getWaktuShift", {
                    params: {
