          ...
          <div class="card">
            <div class="card-header">
              <div class="d-flex justify-content-between">
                ...
                <h4 class="card-title">No Review {{ no_review }}</h4>
              </div>
            </div>
              ...
              <div class="card-body">
                ...
                <div class="assessment-container">
                  ...
                  >
                    ...
                    >
                      <h5 class="mb-0">{{ item.case_category }}</h5>
                      <i
                        class="bi bi-chevron-down transition-transform"
                        :style="{
                          transform: sectionStates[index]
                            ? 'rotate(180deg)'
                            : 'rotate(0deg)',
                        }"
                      ></i>
                    </div>
                    <div v-show="sectionStates[index]" class="collapse show">
                          ...
                          <table class="table">
                            <thead>
                              <tr class="text-center">
                                <!-- <td>Id User</td> -->
                                <th>Nama User</th>
                                <th>Total Ticket (Score)</th>
                                <th>Global Review (Score)</th>
                                <th>AVG Score</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr
                                class="text-center"
                                v-for="(user1, uIndex) in item.sub_category"
                                :key="uIndex"
                              >
                              <!-- <td>{{ user1.Id_User_Recipient }}</td> -->
                                <td>{{ user1.name }}</td>
                                <td>
                                  <span class="ticket-count"
                                    >{{ user1.Total_Ticket }} Ticket</span
                                  >
                                  <span></span>
                  ...
                  >
                    <span class="text-muted" id="completionStatus"
                      >{{ completionPercentage }}% Total Keseluruhan Nilai</span
                    >
                  </div>
                </div>
              </div>
